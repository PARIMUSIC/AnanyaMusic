...
from AnanyaMusic.utils.database import db
...
try:
    ...
    from AnanyaMusic.utils.database import welcome as wlcm
...
def welcomepic(pic, user, chat, id, uname):
    Image.open("AnanyaMusic/assets/welcome.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((450, 450)) 
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('AnanyaMusic/assets/font.ttf', size=45)
    font2 = ImageFont.truetype('AnanyaMusic/assets/font.ttf', size=90)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "AnanyaMusic/assets/upic.png"
