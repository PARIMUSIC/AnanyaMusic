...
from AnanyaMusic.utils.inline.help import (
    help_back_markup,
    private_help_panel,
    help_pannel_page1,
    help_pannel_page2,
...
async def helper_cb(client, CallbackQuery, _):
    ...
    def get_keyboard_for(cb):
        ...
        page4 = ["hb32", "hb33", "hb34", "hb35", "hb36", "hb37", "hb38", "hb39", "hb40"]
    ...
    if cb == "hb1":
        ...
        await CallbackQuery.edit_message_text(helpers.HELP_40, reply_markup=get_keyboard_for(cb))
